...
{
    const string privateCode = "rDimfZTWU0i7PDELZlwswggUVuiB49b0i3tBMPV83sIg";  //Key to Upload New Info
    const string publicCode = "65cfd6068f40bb0c544cc433";   //Key to download
    const string webURL = "http://dreamlo.com/lb/"; //  Website the keys are for

    public PlayerScore[] scoreList;
    DisplayHighscores myDisplay;

    static Leaderboard instance; //Required for STATIC usability
    void Awake()
    {
